...
spdf@data[, which(colnames(spdf@data)!="Municipality")] <-  round(spdf@data[, which(colnames(spdf@data)!="Municipality")], digits = 2)

spdf@data[, which(colnames(spdf@data)=="Damage_rate")] <-  round(spdf@data[, which(colnames(spdf@data)=="Damage_rate")], digits = 2)
